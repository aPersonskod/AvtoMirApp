...
-- Started on 2024-11-30 00:36:18
...
INSERT INTO public."Анкета" ("Код_анкеты", "Жалобы", "Проблема", "Цели_терапии", "Запрос", "Препятсвия", "Ценности", "Стремления", "Цели", "Код_пациента") VALUES (3, 'SADDSA', 'sdaSDA', 'sadDSA', 'Sasda', 'SAD', 'sda', 'SAD', 'sda', 3);
INSERT INTO public."Анкета" ("Код_анкеты", "Жалобы", "Проблема", "Цели_терапии", "Запрос", "Препятсвия", "Ценности", "Стремления", "Цели", "Код_пациента") VALUES (4, 'asd', 'asd', 'asd', 'asd', 'asd', 'asd', 'asd', 'asd', 4);
INSERT INTO public."Анкета" ("Код_анкеты", "Жалобы", "Проблема", "Цели_терапии", "Запрос", "Препятсвия", "Ценности", "Стремления", "Цели", "Код_пациента") VALUES (5, 'asdsads', 'adsads', 'asdasd', 'asdads', 'asdads', 'asdasd', 'asdasd', 'asdads', 5);
INSERT INTO public."Анкета" ("Код_анкеты", "Жалобы", "Проблема", "Цели_терапии", "Запрос", "Препятсвия", "Ценности", "Стремления", "Цели", "Код_пациента") VALUES (2, 'Жопа чешется', 'До крови расчесал', 'Чтоб не чесалось', 'Почесать аккуратно', 'Боль, слезы, дерьмо', 'Золотой унитаз', 'Чесать на работу а не жопу', 'Почесать без боли', 2);
...
INSERT INTO public."Запись" ("Код_записи", "Дата_и_время_проведения", "Код_пациента", "Код_специалиста", "Код_услуги", "Формат") VALUES (3, '2024-11-28', 2, 1, 2, true);
INSERT INTO public."Запись" ("Код_записи", "Дата_и_время_проведения", "Код_пациента", "Код_специалиста", "Код_услуги", "Формат") VALUES (2, '2024-11-28', 1, 1, 1, true);
INSERT INTO public."Запись" ("Код_записи", "Дата_и_время_проведения", "Код_пациента", "Код_специалиста", "Код_услуги", "Формат") VALUES (1, '2024-11-06', 1, 1, 3, false);
...
INSERT INTO public."Пациент" ("Код_пациента", "ФИО", "Пол", "Почта", "Статус", "Откуда", "Дата_рождения", "Номер_телефона") VALUES (3, 'aSsad dSSDA sdadsa', 'М', 'SADDSA', 'На паузе', 'saddsadsa', '2024-11-27', 'DSAdssda');
INSERT INTO public."Пациент" ("Код_пациента", "ФИО", "Пол", "Почта", "Статус", "Откуда", "Дата_рождения", "Номер_телефона") VALUES (4, 'asddsa asdads asdads', 'M', 'asda@gmail.com', 'Диагностическая', 'VK ad', '1995-07-13', '+79657842231');
INSERT INTO public."Пациент" ("Код_пациента", "ФИО", "Пол", "Почта", "Статус", "Откуда", "Дата_рождения", "Номер_телефона") VALUES (5, 'dsadsa', 'М', 'asdas', 'Диагностическая', 'asdas', '2024-11-28', 'sadsd');
INSERT INTO public."Пациент" ("Код_пациента", "ФИО", "Пол", "Почта", "Статус", "Откуда", "Дата_рождения", "Номер_телефона") VALUES (2, 'assad sadads aassad', 'Ж', 'sddsafdafs@gmail.com', 'На паузе', 'от верблюда', '2000-07-13', '+745454454545');
...
-- Completed on 2024-11-30 00:36:18
